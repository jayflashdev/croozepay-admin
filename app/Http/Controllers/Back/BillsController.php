...
use App\Utility\AdexUtility;
use App\Utility\Clubkonnect;
use App\Utility\Easyaccess;
use App\Utility\MsorgUtility;
use App\Utility\Ncwallet;
use App\Utility\Vtpass;
...
class BillsController extends Controller
{
    ...
    // API Balances
    public function apiBalance(Request $request, $type = '')
    {
