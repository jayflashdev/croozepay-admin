        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.status === "success") {
                    Snackbar.show({text: result.message, pos: 'top-right', backgroundColor: '#28a745'});
                    swal("Successful!", result.message, "success").then(
                        function () {
                            if (result.url) {
                    ...
                    Snackbar.show({text: result.message, pos: 'top-right', backgroundColor: '#dc3545'});
                    if (result.url) {
                        swal("Error!", result.message, "warning").then(
                            function () {
                                if (result.url) {
                                    window.location = result.url;
                                }
            ...
            error: function (xhr) {
                ...
                Snackbar.show({text: errors.message || "An unknown error occurred.", pos: 'top-right', backgroundColor: '#dc3545'});
                // swal("Error!", errors.message || "An unknown error occurred.", "warning");
            },
        });
    });
})()
