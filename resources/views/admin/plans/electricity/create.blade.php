...
@section('title', "Add Bill Plan")

@section('content')
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center justify-content-between">
            <h5 class="mb-0">@lang('Add Electricity Company') </h5>
            <a class="btn btn-primary btn-sm" href="{{route('admin.plan.electricity')}}"> @lang('Back') </a>
        </div>
    </div>
   <div class="card-body">
    <form action="{{route('admin.plan.electricity.store')}}" class="row" method="post" enctype="multipart/form-data">
        @csrf
        <div class="col-md-3 col-6 form-group">
            <label class="form-label">Bill Name</label>
            <input type="text"class="form-control" name="name" required placeholder="Bill Name" value="{{old('name')}}" >
        </div>
