            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                <div class="custom-select-box-two">
                    ...
                    <select class="form-select" onchange="window.location.href=this.value">
                        ...
                        <option value="{{ queryBuild('type', 'credit') }}" {{ request('type') == 'credit' ? 'selected' : '' }}>
                            @lang('Credit Transactions')</option>
                        <option value="{{ queryBuild('type', 'debit') }}" {{ request('type') == 'debit' ? 'selected' : '' }}>
                ...
                <div class="custom-select-box-two">
                    ...
                    <select class="form-select" onchange="window.location.href=this.value">
                        <option value="{{ queryBuild('status', '') }}" {{ request('status') == '' ? 'selected' : '' }}>
                            @lang('All ')</option>
                        <option value="{{ queryBuild('status', 'successful') }}"
                            {{ request('status') == 'successful' ? 'selected' : '' }}>@lang('Successful')</option>
                        <option value="{{ queryBuild('status', 'processing') }}"
                            {{ request('status') == 'processing' ? 'selected' : '' }}>@lang('Processing')</option>
                        <option value="{{ queryBuild('status', 'pending') }}"
                            {{ request('status') == 'pending' ? 'selected' : '' }}>@lang('Pending')</option>
                        <option value="{{ queryBuild('status', 'reversed') }}"
                            {{ request('status') == 'reversed' ? 'selected' : '' }}>@lang('Reversed')</option>
                        <option value="{{ queryBuild('status', 'failed') }}"
                            {{ request('status') == 'failed' ? 'selected' : '' }}>@lang('Failed')</option>
                    </select>
                </div><!-- custom-select-box-two end -->
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <p class="col-6">Service : <span class="badge bg-info">{{ short_trx_type($item->service) }}
                                </span> </p>
